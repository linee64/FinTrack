...
export const ChatWidget: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: 'Привет! Я проанализировал ваши финансы. Чем могу помочь?',
      sender: 'ai',
      timestamp: new Date(),
    },
  ]);
...
3. КРАТКОСТЬ: Отвечай максимально лаконично, по существу и без лишней "воды". Твой ответ должен быть максимально информативным, но коротким.
4. СТРУКТУРА:
